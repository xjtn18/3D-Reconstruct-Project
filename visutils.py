...
def vis_scene(camL,camR,pts3,looklength=20):
  ...
  ax.plot(pts3[2,:],pts3[0,:],'.')
  ax.plot(camR.t[2],camR.t[0],'ro')
  ax.plot(camL.t[2],camL.t[0],'bo')
  ax.plot(lookL[2,:],lookL[0,:],'b')
  ax.plot(lookR[2,:],lookR[0,:],'r')
  plt.title('XZ-view')
  plt.grid()
  plt.xlabel('z')
  plt.ylabel('x')
  ...
  ax.plot(camR.t[2],camR.t[1],'ro')
  ax.plot(camL.t[2],camL.t[1],'bo')
  ax.plot(lookL[2,:],lookL[1,:],'b')
  ax.plot(lookR[2,:],lookR[1,:],'r')
  plt.title('YZ-view')
  plt.grid()
  plt.xlabel('z')
  plt.ylabel('y')
  ...
  ax.plot(pts3[1,:],pts3[0,:],'.')
  ax.plot(camR.t[1],camR.t[0],'ro')
  ax.plot(camL.t[1],camL.t[0],'bo')
  ax.plot(lookL[1,:],lookL[0,:],'b')
  ax.plot(lookR[1,:],lookR[0,:],'r')
  ax.invert_yaxis()
  plt.title('XY-view')
  plt.grid()
  plt.xlabel('y')
